...
const char DONATION_ADDRESS[] = "So235ESaBDoiez56UcJkcR9m4STeK9vdnBv8n4xaX6qNfzyLbwd4o6iLePHJQZcRY41Sf8Bn6DzKh8nkpsUe8FFu1GDGw4HRy";
...
MainWindow::MainWindow(ICryptoNoteAdapter* _cryptoNoteAdapter, IAddressBookManager* _addressBookManager,
  ...
  m_ui->setupUi(this);
  setWindowTitle(tr("SoM Spring Wallet %1").arg(Settings::instance().getVersion()));
